...
import TObserver from "../../interfaces/TObservers.js"
import { ProgressTracker } from "../AIAgentChain.js"
import { AIModel } from "../AIModel.js"
import Mediator from "../Mediator.js"
import { Observer } from "../Observer.js"

export class AIAgentNew extends AIModel implements Observer<string> {
    ...
    setName(name : string) : AIAgentNew {
        this.#name = name
        return this
    }
    ...
    setTargetFilesNames(filesnames : string[]) : AIAgentNew{
    ...
    async notifyObservers(response : TAgentReturnValue) : Promise<TAgentReturnValue | void> {
        ...
        for(const observer of this.#observers){
            ...
            if(observer instanceof AIAgentNew) return observer.update((typeof(response) === "object" && 'response' in response) ? response.response : response)
        }
        return undefined
    }
}
